...
add wave -noupdate -format Literal -radix decimal /tb_RISC/RV/rs1
add wave -noupdate -format Literal -radix decimal /tb_RISC/RV/rs2
...
add wave -noupdate -format Literal -radix decimal /tb_RISC/RV/forw_unit/rs_1
add wave -noupdate -format Literal -radix decimal /tb_RISC/RV/forw_unit/rs_2
add wave -noupdate -format Literal -radix decimal /tb_RISC/RV/forw_unit/rd_ex_mem
add wave -noupdate -format Literal -radix decimal /tb_RISC/RV/forw_unit/rd_mem_wb
add wave -noupdate -format Logic /tb_RISC/RV/forw_unit/reg_write_ex_mem
add wave -noupdate -format Logic /tb_RISC/RV/forw_unit/reg_write_mem_wb
add wave -noupdate -format Logic /tb_RISC/RV/forw_unit/forw_a1
add wave -noupdate -format Logic /tb_RISC/RV/forw_unit/forw_a2
add wave -noupdate -format Logic /tb_RISC/RV/forw_unit/forw_b1
add wave -noupdate -format Logic /tb_RISC/RV/forw_unit/forw_b2
add wave -noupdate -format Literal -radix decimal /tb_RISC/RV/out_forw_a1
add wave -noupdate -format Literal -radix decimal /tb_RISC/RV/out_forw_a2
add wave -noupdate -format Literal -radix decimal /tb_RISC/RV/out_forw_b1
add wave -noupdate -format Literal -radix decimal /tb_RISC/RV/out_forw_b2
add wave -noupdate -divider HDU
add wave -noupdate -format Logic /tb_RISC/RV/enable_pc_id
add wave -noupdate -format Literal /tb_RISC/RV/out_cu
add wave -noupdate -format Literal /tb_RISC/RV/ctrl_hazard
add wave -noupdate -format Logic /tb_RISC/RV/sel_mux_hdu
add wave -noupdate -format Logic /tb_RISC/RV/enable_pc
add wave -noupdate -divider ABS
add wave -noupdate -format Literal -radix decimal /tb_RISC/RV/out_abs
add wave -noupdate -format Logic /tb_RISC/RV/en_abs
add wave -noupdate -format Logic /tb_RISC/RV/sel_alu_abs
add wave -noupdate -format Logic /tb_RISC/RV/en_abs_1
add wave -noupdate -format Logic /tb_RISC/RV/sel_alu_abs_1
add wave -noupdate -format Literal -radix decimal /tb_RISC/RV/out_alu_abs
...
add wave -noupdate -format Literal -expand /tb_RISC/DM/dm
add wave -noupdate -format Literal /tb_RISC/RV/mux_mem/i0
add wave -noupdate -format Literal /tb_RISC/RV/mux_mem/i1
add wave -noupdate -format Literal /tb_RISC/RV/mux_mem/i2
add wave -noupdate -format Literal /tb_RISC/RV/mux_mem/i3
add wave -noupdate -format Literal /tb_RISC/RV/mux_mem/sel
add wave -noupdate -format Literal /tb_RISC/RV/mux_mem/o
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1567 ns} 0}
...
update
WaveRestoreZoom {1430 ns} {1694 ns}
